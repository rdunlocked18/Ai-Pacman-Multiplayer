...
INFO_PANE_COLOR = formatColor(0,.4,0)
SCORE_COLOR = formatColor(0, 0, 0)
...
class InfoPane:
  ...
  def drawPane(self):
    self.scoreText = text( self.toScreen(0, 0  ), self.textColor, "Score Team Red Side :    0", "Times", self.fontSize, "bold")
  ...
  def updateScore(self, score):
    changeText(self.scoreText, "Score Team Red Side: % 4d" % score)
...
class PacmanGraphics:
  ...
  def make_window(self, width, height):
    ...
    begin_graphics(screen_width,
                   screen_height,
                   BACKGROUND_COLOR,
                   "Pacman AI Assignment : Rohit Daftari & Rudresh Sharma")
